...
IMG_SIZE = PIXELS_OFFSET = 9  # кол-во пикселей в строке
PIXELS_NUM = 81             # кол-во пикселей в изображении
...
MIN_SEGMENT_LENGTH = 5        # минимальная длина стороны треугольника
